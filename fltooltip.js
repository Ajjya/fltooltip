...
+function ($) {
  ...
  FLtooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="fltooltip" role="fltooltip"><div class="fltooltip-arrow"></div><div class="fltooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  FLtooltip.prototype.getCalculatedOffset = function (placement, pos, actualWidth, actualHeight) {
  ...
  FLtooltip.prototype.getViewportAdjustedDelta = function (placement, pos, actualWidth, actualHeight) {
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      if (!data) $this.data('bs.fltooltip', (data = new FLtooltip(this, options)))
